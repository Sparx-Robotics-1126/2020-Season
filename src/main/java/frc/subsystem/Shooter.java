...
public class Shooter extends Subsystem {
	...
	public void startLimelightAiming() {
		...
		turretCommand = new ScannerTarget(shooterSensors, driveSensors, new ScanForTarget(shooterSensors, driveSensors),
				new LimelightTurret(shooterSensors, driveSensors));
	}
